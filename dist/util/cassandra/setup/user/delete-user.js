...
var jwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJpZCI6IjQzYWFmMmNkLWU5MDktNDA5ZS05OWYzLTY4M2QyYWQ3ZDZiMiIsImV4cCI6MTU1ODU1MTY5MiwiaWF0IjoxNTU1OTU5NjkyfQ.nm-EATbpfNxTWLh5DzJ_rQxVgropEwhyVwQzGOUHYbA";
function deleteUser() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log("User not deleted: " + JSON.stringify(err_1.response.data, null, 2));
                    return [3 /*break*/, 3];
